    ...
    <div className="container mt-4">
      ...
      <div className="card shadow-sm p-4 mb-5">
        <div className="row align-items-center">
          <div
            className="col-md-3 text-center mb-4 mb-md-0 d-flex flex-column align-items-center justify-content-start"
            style={{ minHeight: "180px" }}
          >
            <div className="mb-3" style={{ maxHeight: "130px", width: "100%" }}>
              {data?.logoUrl ? (
                <img
                  src={data.logoUrl}
                  alt="Company Logo"
          ...
          <div className="col-md-9">
            ...
            <p className="mb-2">
              ...
              <span>
                {data.email || <em className="text-muted">Not available</em>}
              </span>
            </p>
            <p className="mb-2">
              <span className="fw-semibold text-muted">🏭 Industry:</span>{" "}
              {data.industry}
            </p>
            <p className="mb-2">
