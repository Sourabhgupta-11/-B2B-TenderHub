  ...
  return (
    <div className="th-page container" style={{ paddingTop: 80, paddingBottom: 60 }}>
      ...
      <div className="th-page-header">
        ...
        {/* Link instead of <a> avoids full page reload */}
        <Link to="/create-tender" className="btn btn-primary btn-sm px-3">
      ...
      {editingId && (
        <div className="card p-4 mb-4">
          <div className="d-flex align-items-center justify-content-between mb-3">
            <h5 className="mb-0">
              <i className="bi bi-pencil-square me-2 text-primary" />Edit Tender
            </h5>
              ...
              <div className="col-12">
                <button type="submit" className="btn btn-primary px-4" disabled={saving}>
                  {saving
                    ...
                    : <><i className="bi bi-check-circle-fill me-1" />Save Changes</>}
                </button>
              </div>
            </div>
          </form>
      ...
      {!loading && tenders.length === 0 && (
        <div className="th-empty">
          {/* Direct child <i> → gets the 2rem size from theme.css .th-empty > i */}
          ...
          {/* Icon inside the button uses font-size: inherit so it stays button-sized */}
          <Link to="/create-tender" className="btn btn-primary btn-sm px-4">
            <i className="bi bi-plus-circle-fill me-1" style={{ fontSize: 'inherit' }} />
            Post a Tender
          </Link>
        </div>
      )}
